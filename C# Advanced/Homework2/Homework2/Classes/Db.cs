        ...
        public static List<Vehicle> Vehicles = new List<Vehicle>()
            {
                ...
                new Car() {BatchNumber = 2 , Id = 0 , Type ="Bike", YearOfpProduction =2016},
                new Bike() {BatchNumber = 3 , Id = 0 , Type ="Bike", YearOfpProduction =2009},
                new Vehicle() {BatchNumber = 4 , Id = 7 , Type ="Vehicle", YearOfpProduction =2014},
                new Car() {BatchNumber = 5 , Id = 12 , Type ="Car", YearOfpProduction =2023},
                new Bike() {BatchNumber = 6 , Id = 20 , Type ="Car", YearOfpProduction =2022},
